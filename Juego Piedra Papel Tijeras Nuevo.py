...
while(res == 1):
    ...
    elif ((jugada == "Papel") and (jugadaMaquina == "Piedra")):   
        print ("Ganaste Jugador. La máquina jugó:  " + str(jugadaMaquina) + "\n");
    elif ((jugada == "Tijera") and (jugadaMaquina == "Papel")):
        print ("Ganaste Jugador. La máquina jugó:  " + str(jugadaMaquina) + "\n");

    if ((jugadaMaquina == "Piedra" and (jugada == "Tijera"))):
        print ("Uy te ganó la Máquina porque jugó: " + str(jugadaMaquina) + "\n");
    elif ((jugadaMaquina == "Papel" and (jugada == "Piedra"))):
        print ("Uy te ganó la Máquina porque jugó: " + str(jugadaMaquina) + "\n");  
    elif ((jugadaMaquina == "Tijeras" and (jugada == "Papel"))):
        print ("Uy te ganó la Máquina porque jugó: " + str(jugadaMaquina) + "\n");
